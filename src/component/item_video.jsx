...
const VideoItem = (props) => {
    return(
        <>
            ...
            <iframe src="https://drive.google.com/file/d/1GonxwNX3sXvqK5BjmvpCTjczMNshsSOm/preview" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <div className="mt-4">
